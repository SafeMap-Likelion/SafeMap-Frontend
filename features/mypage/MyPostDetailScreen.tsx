...
function PostTitle({ onEditPress }: { onEditPress?: () => void }) {
  return (
    <>
...
// 게시물 본문 컴포넌트
function PostContent({ onEditPress }: { onEditPress?: () => void }) {
  ...
  return (
    <VStack>
      <PostTitle onEditPress={onEditPress} />
  ...
  return (
    <Box flex={1} bg="$white" pt={60}>
      ...
      >
        ...
        {/* 게시물 내용 (수정 버튼은 제목 옆에) */}
        <PostContent onEditPress={handleEdit} />
      </ScrollView>
    </Box>
  );
}
